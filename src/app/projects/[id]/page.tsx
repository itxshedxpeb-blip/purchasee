      ...
      try {
        ...
        if (data.success) {
          ...
          setProject({
            ...
            totalAmount,
            purchases: projectData.purchases.map((p: any) => ({
              id: p.id,
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-sm md:text-base font-semibold text-blue-600 mb-1">{project.siteCode}</h1>
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900">{project.name}</h2>
          <p className="text-gray-500 mt-2">{project.clientName} • {project.purchaseCount} purchases</p>
        </div>
      </div>
        ...
        <CardContent className="p-6">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-2xl md:text-3xl font-bold text-gray-900">{formatCurrency(project.totalAmount)}</p>
            </div>
          </div>
        </CardContent>
      </Card>
                  ...
                  >
                    ...
                    <div className="space-y-1 text-sm">
                      <div className="flex justify-between">
                        ...
                        <span className="text-gray-900">{purchase.vendor.name}</span>
                      </div>
                      <div className="flex justify-between">
